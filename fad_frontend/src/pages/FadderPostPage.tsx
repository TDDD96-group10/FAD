import {  Group,  Stack, Title, Card, Text, Center } from '@mantine/core';
...
const FadderPostPage: React.FC = () => {
  ...
  return (
         ...
         <Card shadow="sm" padding="lg" radius="md" style={{ margin: '1rem' }}  withBorder >
